...
const loader = (callback) => {
  ...
  if (window.innerWidth > window.innerHeight) {
    tl
      ...
      .staggerFromTo(document.querySelectorAll('.header__time span'), 0.7, { y: '50%', opacity: 0, ease: Power3.easeOut }, { y: '0%', opacity: 1, ease: Power3.easeOut }, 0.12, 3.5)
    ...
    tl
      ...
      .staggerTo(bottomPath, 0.3, { opacity: 0, ease: Power3.easeInOut }, 0.05, 1.2)
      .staggerTo(bottomPath, 0.3, { opacity: 1, ease: Power3.easeInOut }, 0.05, 1.8)
      .staggerFromTo(document.querySelectorAll('.header__time span'), 0.7, { y: '100%', ease: Power3.easeOut }, { y: '0%', opacity: 1, ease: Power3.easeOut }, 0.12, 3.5)
      .to(document.querySelector('.header__time-wrapper'), 0.5, {
        opacity: 1,
        ease: Power3.easeInOut,
        onComplete: () => {
