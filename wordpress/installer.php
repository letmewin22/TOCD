...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200525_timeforthecloseddoors_f9ab1171bc5708048220_20200525080650_archive.zip';
	const ARCHIVE_SIZE		 = '29342027';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f9ab117-25080650';
    const SECONDARY_PACKAGE_HASH = 'faa4406-25080650';
